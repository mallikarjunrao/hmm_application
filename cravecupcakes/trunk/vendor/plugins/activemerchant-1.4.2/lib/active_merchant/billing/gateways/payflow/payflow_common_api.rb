module ActiveMerchant #:nodoc:
  module Billing #:nodoc:
    module PayflowCommonAPI
      ...
      CVV_CODE = {
        'Match' => 'M',
        'This transaction has been declined due to incorrect credit card details. Please edit the order and verify the card number, expiration date, and card code.' => 'N',
