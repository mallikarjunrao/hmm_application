  ...
  module Billing 
    ...
    class AVSResult
      MESSAGES = {
        ...
        'C' => 'This transaction has been declined due to an incorrect billing address. Please edit the order and enter the correct billing address.',
        ...
        'N' => 'This transaction has been declined due to an incorrect billing address. Please edit the order and enter the correct billing address.',
