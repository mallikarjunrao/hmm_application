...
require 'advertiser_controller'

# Re-raise errors caught by the controller.
class AdvertiserController; def rescue_action(e) raise e end; end

class AdvertiserControllerTest < Test::Unit::TestCase
  fixtures :advertiser_details

  def setup
    @controller = AdvertiserController.new
