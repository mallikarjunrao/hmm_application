...
class HmmUsers < ActiveRecord::Base
...
#self.hashed_password.blank? || !self.password.blank?
  ...
  #validates_uniqueness_of :v_user_name, :case_sensitive => false
#  validates_uniqueness_of :v_e_mail, :case_sensitive => false
#  def check_users
#    attr_protected :v_password, :enabled
#    attr_accessor :v_password
#    
