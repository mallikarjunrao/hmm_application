/*****************************************************************
 *
 * jsProgressBarHandler 0.3.0 - by Bramus! - http://www.bram.us/
 *
  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			width		: 65,										// Width of the progressbar - don't forget to adjust your image too!!!
			boxImage	: '/images/progress_image/percentImage.png',			// boxImage : image around the progress bar
			barImage	: '/images/progress_image/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
		...
		JS_BRAMUS.jsProgressBar.prototype = {
			 ...
			 */
				initialize		: function(el, percentage, options) {
					...
					this.pxPerPercent	= this.options.width / 500;		// Define how much pixels go into 1%
