	...
	public class VistaFlowContainer extends CoverFlowContainer implements IFocusManagerComponent
	{
		...
		protected function layoutVistaFlow(uncaledWidth:Number, unscaledHeight:Number):void {
			...
			for(var i:int=0; i<n; i++) {
				...
				var zPosition:Number = -camera.z/2 + (stackIndex * verticalGap + 100)*i;
				var xPosition:Number = -stackIndex * horizontalGap*Math.cos(zPosition);
				var yPosition:Number = -(maxChildHeight - child.height)/2+ Math.sin(zPosition);
