...
function change_category(val)
	{
		...
		if (val=='Others') 
		{   //alert();
			document.getElementById('new_ca').style.display = 'block';
		}
		else
		{
			document.getElementById('new_ca').style.display = 'none';
		}
	}
...
{
 var val3=document.frm.fnf_category_other123.value;
 var val2=document.frm.fnf_category.value;
