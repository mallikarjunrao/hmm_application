class FamilywebsitePetscontestController < ApplicationController
  layout 'familywebsite'
  include FamilywebsitePetscontestHelper
  include SortHelper
  helper :sort
  ...
  def intro
    ...
    #      :conditions => "a.moment_id = b.id and a.moment_type = 'image' and a.contest_phase='#{contest_phase}' and a.status='active' and age_groups='18-25'", :order => "a.votes desc", :limit =>"2")

    @topentries_photo_0_to_2 = Contest.find(:all,:select => "a.*, b.*, a.id as contest_id, a.first_name as contest_fname" ,:joins=>"as a, user_contents as b",
      :conditions => "a.moment_id = b.id and a.moment_type = 'image' and a.contest_phase='#{contest_phase}' and a.status='active'", :order => "a.votes desc", :limit =>"8")
    ...
    #      :conditions => "a.moment_id = b.id and a.moment_type = 'image' and a.contest_phase='#{contest_phase}'and a.age_groups='26-35' and a.status='active'", :order => "a.votes desc", :limit =>"2")
    #
    ...
    #      :conditions => "a.moment_id = b.id and a.moment_type = 'image' and a.contest_phase='#{contest_phase}'and a.age_groups='36-50' and a.status='active'", :order => "a.votes desc", :limit =>"2")
    #
    ...
    #      :conditions => "a.moment_id = b.id and a.moment_type = 'image' and a.contest_phase='#{contest_phase}'and a.age_groups='50+' and a.status='active'", :order => "a.votes desc", :limit =>"2")
    #
